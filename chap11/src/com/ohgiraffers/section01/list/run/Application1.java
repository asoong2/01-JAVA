...
public class Application1 {
    ...
    public static void main(String[] args) {
        ...
        * Object 클래스의 하위 타입 인스턴스를 모두 저장할 수 있다. */
        alist.add("apple");
        alist.add(123);     // 기본자료형이 아닌 래퍼 클래스 타입으로 저장됨 (AutoBoxing : Integer)
        alist.add(45.67);   // (AutoBoxting : Double)
        alist.add(new Date());
        ...
        * Collection에서 사용 되는 기능들을 static 메소드로 구현한 클래스이다. */
        ...
        * 현재의 ArrayList 객체를 LinkedList 객체로 변경한다. */
        ...
        /* LinkedList로 다운캐스팅 한 뒤 descendingIterator() 메소드를 사용하면 내림차순으로
        * 정렬 된 Iterator 타입의 목록을 반환한다.
        *
        * Iterator란?
