...
public class Application2 {
    ...
    public static void main(String[] args) {
        ...
        * String 클래스의 문자열의 길이는 메소드로 제공하므로 length() 로 사용한다. */
        ...
        /* 한 번 지정한 배열의 크기는 변경하지 못한다. 새로운 배열을 생성하여 그 주소 값을 레퍼런수 변수에 덮어 쓴다. */
        darr = new double[30];
        ...
        /* 한 번 할당된 배열은 지울 수 없다.
        * 단 참조되지 않는 배열은 일정 시간이 지난 후 heap의 old 영역으로 이동하여 GC(가비지 컬렉터)가 삭제시킨다.
        * 한 번 찾아갈 수 있는 주소 길을 잃어버린 배열은 다시 참조 불가능하다.
        * */
